...
-module(prop_crdt_bigset).

-define(PROPER_NO_TRANS, true).
-include_lib("proper/include/proper.hrl").

%% API
-export([prop_bigset_spec/0, set_op/0, add_wins_set_spec/1]).


prop_bigset_spec() ->
 crdt_properties:crdt_satisfies_spec(antidote_crdt_bigset, fun set_op/0, fun add_wins_set_spec/1).
